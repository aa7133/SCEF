...
public abstract class S6tAbstractServer extends TBase implements ServerS6tSessionListener {
  ...
  public void init(FileInputStream configStream, String serverId) {
    try {
      ...
      this.sessionFactory.registerAppFacory(ServerS6aSession.class, s6tSessionFactory);
      this.sessionFactory.registerAppFacory(ClientS6aSession.class, s6tSessionFactory);
